...
<div class="row justify-content-center">
  <img src="{{asset('assets\img\Logo.png')}}" class="img-fluid" style="height:150px;">
</div>
<div class="row">

<div class="col-md-12  text-center">
<h2 class="mt-3 font-weight-bold">Omega Secondary School </h2>
<h5>Kumaripati, Lalitpur</h5>
<h6>Tel: 01-5550563/ 01-5008653</h6>
</div>
</div>
<form method="POST" action="/apply" encType="multipart/form-data" class=" mt-3 p-4" style="border:1px solid #d5d5d5;">
<h2 class="text-uppercase font-weight-bold">Application Form for Grade XI</h2>
