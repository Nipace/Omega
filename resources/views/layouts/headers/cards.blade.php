                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <p class="mt-3 mb-0 text-muted text-sm">
                                ...
                                <span class="text-nowrap" style="font-size: 12px">Since last month</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <p class="mt-3 mb-0 text-muted text-sm">
                                ...
                                <span class="text-nowrap"style="font-size: 12px">Since last week</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <p class="mt-3 mb-0 text-muted text-sm">
                                ...
                                <span class="text-nowrap"style="font-size: 12px">Since yesterday</span>
                            </p>
                        </div>
                    </div>
                </div>
