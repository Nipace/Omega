...
Route::get('/home', 'HomeController@index')->name('home')->middleware('password');
Auth::routes(['verify'=>true,'register' => false]);
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('/reset/password','HomeController@savePassword')->name('reset.password');
	Route::group(['middleware' => 'password'], function () {
		Route::resource('user', 'User\UserController');
		// Imoprt User routes
		Route::get('users/import','User\UserController@getImport')->name('user.import');
		Route::post('users/import','User\UserController@fileImport')->name('user.import.store');
